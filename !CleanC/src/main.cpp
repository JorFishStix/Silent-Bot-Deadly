...
void zoom(directionType dir, int num, bool turner, bool pause) {
  if(turner){
    lSide.spinFor(dir, num, turns, false);
    rSide.spinFor(dir, num, turns, pause);
  } else{
    lSide.spinFor(dir, num, degrees, false);
    rSide.spinFor(dir, num, degrees, pause);
  }
}
...
void autonomous(void) {
  lSide.setVelocity(80, pct);
  rSide.setVelocity(80, pct);

  radialArm.setTimeout(2, sec);
  lSide.setTimeout(2, sec);
  rSide.setTimeout(2, sec);
  radialArm.spinTo(260, degrees);

  zoom(reverse, 3, true, true);
  zoom(fwd, 2, true, true);  

  lSide.spinFor(reverse, 1, turns, false);
  rSide.spinFor(fwd, 1, turns);

  lSide.setVelocity(10, pct);
  rSide.setVelocity(10, pct);
  lSide.setMaxTorque(10, pct);
  rSide.setMaxTorque(10, pct);
  dTrain.spinFor(fwd, 1, turns);
}
  ...
  while (1) {
    ...
    // Team Color
      if(!teamPick){
        ...
        // S
        Brain.Screen.drawLine(95, 20, 155, 20);
        Brain.Screen.drawLine(95, 110, 155, 110);
        Brain.Screen.drawLine(95, 200, 155, 200);
        Brain.Screen.drawLine(95, 20, 95, 110);
        Brain.Screen.drawLine(155, 110, 155, 200);
        Brain.Screen.drawLine(155, 20, 155, 40);
        Brain.Screen.drawLine(95, 200, 95, 180);
    


        // B
        Brain.Screen.drawLine(215, 20, 215, 200);
        Brain.Screen.drawLine(215, 20, 275, 20);
        Brain.Screen.drawLine(215, 200, 275, 200);
        Brain.Screen.drawLine(275, 20, 275, 90);
        Brain.Screen.drawLine(275, 130, 275, 200);
        Brain.Screen.drawLine(215, 110, 275, 130);
        Brain.Screen.drawLine(215, 110, 275, 90);

        // D
        Brain.Screen.drawLine(335, 20, 335, 200);
        Brain.Screen.drawLine(335, 20, 370, 20);
        Brain.Screen.drawLine(335, 200, 370, 200);
        Brain.Screen.drawLine(370, 20, 395, 90);
        Brain.Screen.drawLine(370, 200, 395, 130);
        Brain.Screen.drawLine(395, 90, 395, 130);
