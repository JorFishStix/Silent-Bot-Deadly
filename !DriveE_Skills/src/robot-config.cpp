...
motor radialArmMotorA = motor(PORT19, ratio18_1, true);
motor radialArmMotorB = motor(PORT18, ratio18_1, false);
motor_group radialArm = motor_group(radialArmMotorA, radialArmMotorB);
motor fly1 = motor(PORT10, ratio6_1, false);
motor fly2 = motor(PORT2, ratio6_1, true);
rotation armPos = rotation(PORT17, false);
